...
(function (LossReasonCode) {
    ...
    LossReasonCode[LossReasonCode["ImpressionOpportunityExpired"] = 2] = "ImpressionOpportunityExpired";
    ...
    LossReasonCode[LossReasonCode["MissingMinimumCreativeApprovalData"] = 10] = "MissingMinimumCreativeApprovalData";
    ...
    LossReasonCode[LossReasonCode["CreativeFilteredUnknownReason"] = 200] = "CreativeFilteredUnknownReason";
    LossReasonCode[LossReasonCode["CreativeFilteredPendingProcessing"] = 201] = "CreativeFilteredPendingProcessing";
    LossReasonCode[LossReasonCode["CreativeFilteredDisaproved"] = 202] = "CreativeFilteredDisaproved";
    LossReasonCode[LossReasonCode["CreativeFilteredSizeNotAllowed"] = 203] = "CreativeFilteredSizeNotAllowed";
    LossReasonCode[LossReasonCode["CreativeFilteredIncorrectFormat"] = 204] = "CreativeFilteredIncorrectFormat";
    LossReasonCode[LossReasonCode["CreativeFilteredAdvertiserExclusions"] = 205] = "CreativeFilteredAdvertiserExclusions";
    LossReasonCode[LossReasonCode["CreativeFilteredAppBundleExclusions"] = 206] = "CreativeFilteredAppBundleExclusions";
    LossReasonCode[LossReasonCode["CreativeFilteredNotSecure"] = 207] = "CreativeFilteredNotSecure";
    LossReasonCode[LossReasonCode["CreativeFilteredLanguageExclusions"] = 208] = "CreativeFilteredLanguageExclusions";
    LossReasonCode[LossReasonCode["CreativeFilteredCategoryExclusions"] = 209] = "CreativeFilteredCategoryExclusions";
    LossReasonCode[LossReasonCode["CreativeFilteredAttributeExclusions"] = 210] = "CreativeFilteredAttributeExclusions";
    LossReasonCode[LossReasonCode["CreativeFilteredAdTypeExclusions"] = 211] = "CreativeFilteredAdTypeExclusions";
    LossReasonCode[LossReasonCode["CreativeFilteredAnimationTooLong"] = 212] = "CreativeFilteredAnimationTooLong";
    LossReasonCode[LossReasonCode["CreativeFilteredNotAllowedInPMPDeal"] = 213] = "CreativeFilteredNotAllowedInPMPDeal";
