...
exports.Gender =
    ...
    exports.IQGMediaRating =
    exports.ContentContext =
    exports.VolumeNormalizationMode =
    exports.FeedType =
    exports.ContentDeliveryMethod =
    exports.CompanionType =
    exports.ProductionQuality =
    exports.StartDelay =
    exports.PlaybackCessationMode =
    exports.PlaybackMethod =
    exports.VideoPlacementType =
    exports.Protocol =
    exports.VideoLinearity =
    exports.APIFramework =
    exports.ExpandableDirection =
    exports.AdPosition =
    exports.CreativeAttribute =
    exports.BannerAdType =
        void 0
var BannerAdType
...
;(function (CreativeAttribute) {
    ...
    CreativeAttribute[(CreativeAttribute['ExpandableUserInitiatedClick'] = 4)] =
        'ExpandableUserInitiatedClick'
    CreativeAttribute[(CreativeAttribute['ExpandableUserInitiatedRollover'] = 5)] =
        'ExpandableUserInitiatedRollover'
    CreativeAttribute[(CreativeAttribute['InBannerVideoAdAutoPlay'] = 6)] =
        'InBannerVideoAdAutoPlay'
    CreativeAttribute[(CreativeAttribute['InBannerVideoAdUserInitiated'] = 7)] =
    ...
    CreativeAttribute[(CreativeAttribute['WindowsDialogOrAlertStyle'] = 14)] =
...
;(function (VideoPlacementType) {
    ...
    VideoPlacementType[(VideoPlacementType['InterstitialSliderFloating'] = 5)] =
...
;(function (PlaybackCessationMode) {
    ...
    PlaybackCessationMode[(PlaybackCessationMode['OnLeavingViewportUntilVideoCompletion'] = 3)] =
        'OnLeavingViewportUntilVideoCompletion'
...
;(function (VolumeNormalizationMode) {
    ...
    VolumeNormalizationMode[(VolumeNormalizationMode['AdVolumeAverageNormalizedToContent'] = 1)] =
        'AdVolumeAverageNormalizedToContent'
    VolumeNormalizationMode[(VolumeNormalizationMode['AdVolumePeakNormalizedToContent'] = 2)] =
        'AdVolumePeakNormalizedToContent'
    VolumeNormalizationMode[(VolumeNormalizationMode['AdLoudnessNormalizedToContent'] = 3)] =
        'AdLoudnessNormalizedToContent'
    VolumeNormalizationMode[(VolumeNormalizationMode['CustomVolumeNormalization'] = 4)] =
        'CustomVolumeNormalization'
})(
    (VolumeNormalizationMode =
        exports.VolumeNormalizationMode || (exports.VolumeNormalizationMode = {}))
)
var ContentContext
...
;(function (ConnectionType) {
    ...
    ConnectionType[(ConnectionType['CellularNetworkUnknownGeneration'] = 3)] =
        'CellularNetworkUnknownGeneration'
