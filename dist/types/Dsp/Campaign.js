...
(function (CampaignStatus) {
    ...
    CampaignStatus[CampaignStatus["created"] = 1] = "created";
    CampaignStatus[CampaignStatus["inReview"] = 2] = "inReview";
    CampaignStatus[CampaignStatus["ready"] = 3] = "ready";
    CampaignStatus[CampaignStatus["active"] = 4] = "active";
    CampaignStatus[CampaignStatus["paused"] = 5] = "paused";
    CampaignStatus[CampaignStatus["closedByUser"] = 6] = "closedByUser";
    CampaignStatus[CampaignStatus["expired"] = 7] = "expired";
    CampaignStatus[CampaignStatus["exhausted"] = 8] = "exhausted";
